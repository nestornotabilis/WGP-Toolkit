//==============================================================================
//
//   BasespaceToFakespace.java
//   Created: Oct 30, 2012 at 3:49:43 PM
 ...
 * @author  Kevin Ashelford.
 */
public class BasespaceToFakespace implements Constants {
	...
	// CONSTRUCTOR
	/**
	 * Creates a new instance of <code>BasespaceToFakespace</code>.
	 */
	public BasespaceToFakespace(
		final File infile,
		final File outfile
		) throws IOException {
		...
		IFileConvertor fc =
                        FileConvertorFactory.getFileConvertor(
                                FileConversion.BasespaceToFakespace
                                );
