//==============================================================================
//
//   BasespaceToColourspace.java
//   Created: Oct 30, 2012 at 3:16:55 PM
 ...
 * @author  Kevin Ashelford.
 */
public class BasespaceToColourspace implements Constants {
	...
	/**
	 * Creates a new instance of <code>BasespaceToColourspace</code>.
	 */
	public BasespaceToColourspace(
		final File infile,
		final File outfile
		) throws IOException {
		...
		IFileConvertor fc =
			FileConvertorFactory.getFileConvertor(
				FileConversion.BasespaceToColourspace
                );
