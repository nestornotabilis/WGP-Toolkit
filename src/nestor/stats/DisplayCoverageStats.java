 ...
 * @author  Kevin Ashelford.
 */
public class DisplayCoverageStats {
...
//			"N50",
			...
			//"fraction covered",
			//"fraction covered >= 4x",
			//"fraction covered >= 10x",
			//"fraction covered >= 20x",
			//"fraction covered >= 30x"
			);
...
//			stats.getN50(),
			...
			stats.getMaximum(),
			stats.getRange(),
			stats.getNumberBasesCovered(),
			stats.getNumberBasesCovered4x(),
			stats.getNumberBasesCovered10x(),
			stats.getNumberBasesCovered20x(),
			stats.getNumberBasesCovered30x()
			);
